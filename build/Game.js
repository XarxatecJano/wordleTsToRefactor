...
var _Game_pickedWord, _Game_actualWord, _Game_turn, _Game_actualPosition, _Game_validLetterCodes, _Game_background, _Game_letterClass;
...
export class Game {
    constructor(pickedWord) {
        ...
        _Game_letterClass.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _Game_background, new Background(), "f");
        __classPrivateFieldSet(this, _Game_letterClass, new Letter(), "f");
    }
    get pickedWord() {
    ...
    get background() {
        return __classPrivateFieldGet(this, _Game_background, "f");
    }
    set background(i) {
        __classPrivateFieldSet(this, _Game_background, i, "f");
    }
    isValidLetter(code) {
    ...
    newLetter(code) {
        ...
        __classPrivateFieldGet(this, _Game_letterClass, "f").setNewLetter(this.turn, this.actualPosition, letter);
    ...
    enterPressed() {
        if (__classPrivateFieldGet(this, _Game_actualWord, "f").length == MAX_WORD_SIZE) {
            ...
            for (let i = 0; i < __classPrivateFieldGet(this, _Game_actualWord, "f").length; i++) {
                __classPrivateFieldGet(this, _Game_background, "f").changeBackgroundKey(`Key${__classPrivateFieldGet(this, _Game_actualWord, "f")[i]}`);
            }
    ...
    backspacePressed() {
        if (__classPrivateFieldGet(this, _Game_actualPosition, "f") > 0) {
            __classPrivateFieldSet(this, _Game_actualPosition, __classPrivateFieldGet(this, _Game_actualPosition, "f") - 1, "f");
            __classPrivateFieldGet(this, _Game_letterClass, "f").deleteLetter(__classPrivateFieldGet(this, _Game_turn, "f"), __classPrivateFieldGet(this, _Game_actualPosition, "f"));
...
_Game_pickedWord = new WeakMap(), _Game_actualWord = new WeakMap(), _Game_turn = new WeakMap(), _Game_actualPosition = new WeakMap(), _Game_validLetterCodes = new WeakMap(), _Game_background = new WeakMap(), _Game_letterClass = new WeakMap();
